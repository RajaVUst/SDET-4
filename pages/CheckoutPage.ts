...
export class CheckoutOverviewPage {
    ...
    async enterGuestInformation(data: CheckoutData) {
        ...
        await this.page
            .locator(CheckoutOverviewLocators.guestName)
            .fill(data.name);

        await this.page
            .locator(CheckoutOverviewLocators.guestEmail)
            .fill(data.email);

        await this.page
            .locator(CheckoutOverviewLocators.guestPhone)
            .fill(data.phone);

        await this.page
            .locator(CheckoutOverviewLocators.street)
            .fill(data.street);

        await this.page
            .locator(CheckoutOverviewLocators.city)
            .fill(data.city);

        await this.page
            .locator(CheckoutOverviewLocators.state)
            .selectOption(data.state);

        await this.page
            .locator(CheckoutOverviewLocators.zip)
            .fill(data.zip);

        await this.page
            .locator(CheckoutOverviewLocators.country)
            .fill(data.country);
    ...
    async completeGuestCheckout(data: CheckoutData) {

        await this.verifyCheckoutPageLoaded();

        await this.enterGuestInformation(data);
